...
# preprocessing and no feature engineering output 42 features by using liable encoding on all object types
# Functions
...
def import_train_test():
    ...
    #print(nan_count)
    train = pd.read_csv('../Dataset/train_data_pp.csv',low_memory=False) # full dataset
    test = pd.read_csv('../Dataset/test_data_pp.csv', low_memory=False) # full dataset
    print('dataset in shape of train: ', train.shape)
    print('dataset in shape of tes: ', test.shape)
    ...
    for df in [train, test]:
        ...
        df['srcip'] = labelencoder.fit_transform(df['srcip'])
...
print("line93: train shap: ",train.shape)
...
#x_train, x_test = feature_engineer(x_train), feature_engineer(x_test) #train, test

print("line111 train shap: ",train.shape)
print("linex112 x_train shap ",x_train.shape)
...
print("all categorical_columns: \n",categorical_columns)

print(x_train.head())
print("linex119 x_train shap ",x_train.dtypes)
...
print("linex128 x_train datatype ",x_train.dtypes)
print(x_train.head())
